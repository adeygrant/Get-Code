    ...
    It 'should determine the correct answer' {
        function Get-GreatestVarianceDate {
            ...
            foreach ($day in $Data){
                ...
                try {
                    [double]$open = $string[1]
                    [double]$close = $string[6]
                }
                catch {
                ...
                $hashtable.Add($date, $difference)                

            }

            
            return $hashtable.GetEnumerator() | Sort-Object -Property Value -Descending | Select-Object -ExpandProperty Name -First 1
