...
Describe 'Strings' {
    ...
    Context 'Literal Strings' {
        ...
        It 'assumes everything is literal' {
            ...
            $var | Should -Be 'Some things you must take literally'
        }
    ...
    Context 'Evaluated Strings' {
        ...
        It 'can expand variables' {
            $var = 'apple'
            "My favorite fruit is $var" | Should -Be 'My favorite fruit is apple'
        }

        It 'can do a simple expansion' {
            $Windows = Get-Item 'C:\Windows' | Select-Object -ExpandProperty FullName
            "The windows directory is located here: $Windows" | Should -Be 'The windows directory is located here: C:\Windows'
        }

        It 'handles other ways of doing the same thing' {
            $String = "The windows directory is located at $(Get-Item 'C:\Windows')"
            $String | Should -Be 'The windows directory is located at C:\Windows'
        }
        ...
        It 'can escape special characters with backticks' {
            ...
            $String | Should -Be '$LetterA contains Apple.'
        }
    ...
    Context 'Substrings' {
        ...
        It 'lets you select portions of a string' {
            ...
            $String.Substring(0, 6) | Should -Be 'At the'
            $String.Substring(7) | Should -Be 'very top!'
        }
    }
...
"@ # These can mess with indentation patterns, but have their uses nonetheless!
            ...
            $String | Should -Be 'I am number #20!'
        }
...
"@
            $AllYourQuotes | Should -Be "All things that are not 'evaluated' are `"recognised`" as characters."
        }
    }
}
