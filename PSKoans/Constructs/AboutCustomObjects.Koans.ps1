...
Describe '[PSCustomObject]' {
    ...
    It 'can be built by trimming objects down' {
        ...
        $Object | Should -BeOfType PSCustomObject
        'cca07' | Should -Be $Object.Parent.Name
    }

    It 'can have arbitrary properties' {
        $Object = [PSCustomObject]@{ 'Wutson' = 'Enter Property Name' }

        1 | Should -Be $Object.PSObject.Properties.Count
        $Object.PSObject.Properties.Name | Should -Be 'Wutson'
    }

    It 'can be added to' {
        $Object = [PSCustomObject]@{ 'Property1' = 12 }
        $Object | Add-Member -MemberType NoteProperty -Name 'Property2' -Value 5
    ...
    It 'can have ScriptProperties' {
        ...
        2 | Should -Be $Object.DerivedProperty
        # What if we call it more than once?
        3 | Should -Be $Object.DerivedProperty
    }
    ...
    It 'can declare ScriptProperties without Add-Member with custom getters and setters' {
        ...
        12 | Should -Be $Object.CustomProperty
        $Object.CustomProperty = 12
        -11 | Should -Be $Object.CustomProperty
        -12 | Should -Be $Object.BaseProperty
    }
}