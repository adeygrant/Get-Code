...
Describe 'Lists' {
    ...
    Context 'Strict Typing' {
        ...
        It 'can enforce strict typing on its contents' {
            ...
            $IntList[0] | Should -Be 7
            $IntList[1] | Should -Be 5
        }
