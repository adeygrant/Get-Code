...
Describe 'New-Object' {
    ...
    It 'can create objects of a specified type' {
        ...
        $Object | Should -BeOfType 'System.Collections.Hashtable'
    }

    It 'can create objects of any available type' {
        $PSObject = New-Object -TypeName 'PSObject'
        $PSObject | Should -BeOfType 'System.Management.Automation.PSCustomObject'
    }
    ...
    It 'is just one way to instantiate an object' {
        ...
        $Object2 | Should -BeOfType System.Management.Automation.PSObject
    }
}