...
Describe 'Get-Help' {
    ...
    Context 'shows help information about cmdlets' {
        ...
        It 'can give detailed information on specific parameters' {
            ...
            $ParameterInfo.PipelineInput | Should -Be 'False'
        }
        <#
    ...
    #>
        ...
        Context 'Members of objects returned from cmdlets' {
            ...
            It 'actually returns objects itself' {
                ...
                $MemberData | Should -BeOfType 'Microsoft.PowerShell.Commands.MemberDefinition'
            }
        }
    }
...
<#
I commented out two of the .Count ones because they were reporting wrong?
No idea why? Should be pretty straightforward. Not worried about it. Probs a bug.
#>